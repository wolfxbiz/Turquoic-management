...
import { X, Save, Shield, User, Key } from 'lucide-react';
                ...
                >
                    <div className="p-8 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-xl font-black text-gray-800 tracking-tight">Edit Employee</h2>
                                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-0.5">Update Details</p>
                            </div>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-8 space-y-6">
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 ml-1">Reset Password (Optional)</label>
